...
func _physics_process(delta: float) -> void:
	...
	var target_horizontal_direction: Vector3 = follow_target.global_basis.z.slide(Vector3.UP).normalized()
	var desired_basis: Basis = Basis.looking_at(-target_horizontal_direction)
